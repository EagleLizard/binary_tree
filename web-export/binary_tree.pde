...
final int ITERS = 12;//number of iterations to draw the tree
final float ANGLE_FACTOR = 7*PI/18;//constant for setting the angle factor of the tree
final float SHRINK_FACTOR = 0.65;
